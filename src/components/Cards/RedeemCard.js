...
export const RedeemCard = ({ slug }) => {
  const {  redeemCard, setRedeemCard } = GlobalContext();
  return (
            ...
            <div className=" py-3 px-3">
              <div className="h-[60%] mt-[20px] mb-auto bg-transparent rounded-2xl w-[95%] text-lg border border-white ml-auto mr-auto">
                <input
                  ...
                  type="text"
                  placeholder={`Enter X${slug} Amount`}
                />
              </div>
              <div className="bg-white/0 border border-white rounded-xl py-3 px-3 h-24 w-[96%] mt-[80px] ml-auto mr-auto ">
                <p className="text-center">Redeemable X{slug} Amount</p>
                <p className="py-1 px-2 text-center h-9 ml-auto mr-auto w-[70%] mt-2 rounded-2xl  bg-black/25 text-white border border-white">
                  0
                </p>
              </div>
              <div className="bg-white/0 flex  items-center rounded-xl py-3 px-3 h-24 w-[96%] mt-[48px] ml-auto mr-auto ">
                <button className="ml-auto mr-auto h-10 rounded-xl border border-white w-[70%] hover:bg-red-600 hover:text-white ">Redeem X{slug}</button>
              </div>
            </div>
          </div>
        </div>
